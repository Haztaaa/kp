...
<h1 class="h3 mb-4 text-gray-800">Edit</h1>
    ...
    <div class="row">
        ...
        <?= form_open_multipart('user/data_usulan/ubah/'. $penerima['id']) ?>
        ...
        <label for="role_id" class="form-label">Kecamatan</label>
            <select name="id_kecamatan" id="id_kecamatanubah" class="form-control">
          ...
          <div class="forms-group-row col-lg-10">
        <label for="role_id" class="form-label">Kelurahan</label>
            <select name="desa" id="desaubah" class="form-control" >
            
            <?php foreach($desa as $d) :?>
            <?php if($d['id'] == $penerima['id_desa']) : ?>
            <option value="<?= $d['id']; ?>"selected><?= $d['desa']; ?></option>
            <?php else : ?>
        ...
        <label for="role_id" class="form-label">Tahun</label>
            <select name="id_tahun" id="id_tahunubah" class="form-control">
        ...
        <label for="role_id" class="form-label">Jenis Bantuan</label>
            <select name="id_jbantuan" id="id_jbantuanubah" class="form-control">
        ...
        <div class="col-sm-10">
            <input type="text" name="nik" class="form-control" id="nik" value="<?= $penerima['nik']; ?> " readonly>
        </div>
        </div>
        ...
        <div class="col-sm-10">
            <input type="text" name="nama_usulan" class="form-control" id="nama_usulan"  value="<?= $penerima['nama_usulan']; ?>">
        </div>
        </div>
        <div class="form-group-row">
        ...
        <div class="col-sm-10">
            <input type="text" name="penghasilan" class="form-control" id="pekerjaan" value="<?= $penerima['penghasilan']; ?>">
            <?= form_error('pekerjaan','<small class="text-danger pl-3">','</small>'); ?>
        </div>
        </div>
