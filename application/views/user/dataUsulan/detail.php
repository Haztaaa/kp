                ...
                <div class="container-fluid">
                    ...
                    <div class="ml-2">
                    <label for="nama" class="card-title text-uppercase font-weight-bold text-dark">Kelurahan</label>
                   ...
                   <label for="nama" class="card-title text-uppercase font-weight-bold text-dark">Alamat Lengkap</label>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?= base_url('user/data_usulan')?>" class="btn btn-primary float-right ml-2">Kembali</a>
                        </div>
                        </div>
